...
export type IonicColumnBaseSettings = {
  plinth: ColumnPlinth;
  torus: ColumnTorus;
  scotia: ColumnScotia;
  torus2: ColumnTorus;
...
export function ionicColumnBase(
  settings: IonicColumnBaseSettings,
  material: Material,
) {
...
/// #if DEBUG
export class GUIIonicBase extends GUIController {
  constructor(
    gui: GUIType,
    public target: IonicColumnBaseSettings,
  ) {
    super(gui);
